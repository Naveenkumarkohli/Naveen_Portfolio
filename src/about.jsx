...
function About(){
    return(
        <div className='w-full h-full flex flex-col items-center justify-center md:flex-row-reverse relative' id='about'>
            ...
            <h2 className='flex items-center h-10 text-xl my-5 md:absolute md:top-12 md:py-7 md:my-0 md:text-2xl lg:text-3xl xl:4xl'>About Me <img src={Smile} alt='smile'  className='mx-2'/></h2>
            <div className='font-bold mx-5 md:w-1/3 md:mr-16 md:text-xl lg:text-2xl xl:text-3xl'>
                {about.content}
            </div>
