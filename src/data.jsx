...
const projects_skills = {
    ...
    projects: {
        ...
        ai_chatbot: {
            ...
            `,
            thumbnail: process.env.NODE_ENV === 'production' ? '/Naveen_Portfolio/images/ai_chatbot.png' : '/images/ai_chatbot.png',
            images: [process.env.NODE_ENV === 'production' ? '/Naveen_Portfolio/images/ai_chatbot.png' : '/images/ai_chatbot.png'],
